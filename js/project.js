...
function displayModalData(ele) {
  ...
  modalProject.innerHTML = `<iframe width="560" height="315" src="${p_data.project_video_link}" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>`;
